...
<script>
        ...
        getOptions = function () {
            ...
            xhttp.open("GET", "g_l_viewHistory.php", false);
            xhttp.send();
          obj = JSON.parse(xhttp.responseText);
          var table = $('#datatable').DataTable();
        for ( x in obj )
        {
            if(obj[x].status=="Approve" || obj[x].status=="Reject" ||obj[x].status=="Expired")
            {
            table.row.add( [
                obj[x].no,
                obj[x].name,
            ...
            //    '<button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" onclick="updateExam('+ obj[x].event_id +')"><i class="fas fa-pencil-alt"></i></button>'
               //'<button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete"><i class="far fa-trash-alt"></i></button>'
